...
CDH_HADOOP_CONF = "/etc/hadoop/conf"
if os.path.exists(CDH_HADOOP_CONF):
    CLASS_PATH = "%s:%s" % (CLASS_PATH, CDH_HADOOP_CONF)
...
def generateJobConfigTemplate(reader, writer):
    readerRef = "Please refer to the %s document:\n     https://git.apuscn.com:8443/Data-Dev/apus-datax/blob/master/%s/doc/%s.md \n" % (reader,reader,reader)
